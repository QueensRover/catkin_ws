...
uint16_t motorAddress[][2] = {{128, 6},{130, 6},{130, 7},{128, 7}};
/*
	0 --> Front Left
	1 --> Front Right
	2 --> Back Left
...
void voltageControl() {
	motorSpeed[motor_FL] = setPoints[0]*63.0 + stopCommand;
	motorSpeed[motor_FR] = -setPoints[1]*63.0 + stopCommand;
	motorSpeed[motor_BL] = setPoints[0]*63.0 + stopCommand;
	motorSpeed[motor_BR] = -setPoints[1]*63.0 + stopCommand;
}//end voltageControl
